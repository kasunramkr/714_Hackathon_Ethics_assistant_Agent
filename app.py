...
def get_bot_response(messageList, token):
    print(messageList)
    headers = {
    ...
    payload = {
        "messages": [{"role": "user", "content": msg} for msg in messageList]
    }
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Thinking..."):
            try:
                ...
                response = get_bot_response(st.session_state.user_input_list, token)
